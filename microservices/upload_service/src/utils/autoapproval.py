...
def get_values(validation_score,extraction_score,matching_score,document_label
    ,document_type):
  '''
  ...
  Logger.info(f"Validation_Score:{validation_score}, Extraction_score :{extraction_score},Matching_Score:{matching_score},DocumentLabel:{document_label},DocumentType:{document_type}" )
