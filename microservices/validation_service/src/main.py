"""
  validtion Service Microservice
"""
import uvicorn
import asyncio
import time
...
app = FastAPI(title="validation Service API")
...
api = FastAPI(title="Validation Service API", version="latest")

api.include_router(validation.router)

app.mount("/validation_service/v1", api)
