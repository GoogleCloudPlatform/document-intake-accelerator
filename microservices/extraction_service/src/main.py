"""
  Extraction Service Microservice
"""
import uvicorn
import asyncio
import time
...
app = FastAPI(title="Extraction Service API")
...
api = FastAPI(title="Extraction Service API", version="latest")

api.include_router(extraction.router)

app.mount("/extraction_service/v1", api)
