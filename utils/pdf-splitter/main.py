...
def main(args: argparse.Namespace) -> int:
    ...
    print(f"Using project_id={args.project_id}, processor_id={args.processor_id} to extract data from file_path={file_path} ")
    ...
    processor_name = client.processor_path(args.project_id, args.multi_region_location, args.processor_id)
