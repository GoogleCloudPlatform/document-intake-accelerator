...
3. Setup application default authentication, run: `gcloud auth application-default login`
4. Run the sample: `python main.py -i <local-path-to-combined-document>.pdf --project-id <DOCAI_PROJECT_ID>  --processor-id <SPLITTER_ID> -o <local-path-to-the-output-directory>`
