...
def generate_data(config, num_rows, **options):
  ...
  # generate fake data
  cities ={1:['Chicago',60655,'Cook County'],2:['Aurora',60502,'Kane County'],3:['Springfield',62702,'Sangamon County'],4:['Bloomington',61704,'McLean County'],5:['Champaign',60949,'Urbana County'],6:['Rockford',61105,'Winnebago County'],7:['Plainfield',60544,'Will and Kendall County'],8:['Normal',61761,'McLean County'],9:['Rock Island',61204,'Rock Island County'],10:['Oak Forest',60302,'Cook County']}
  ...
  for i in data_list:
    ...
    i['time_worked']=(i['work_end_date']-i['work_start_date']).days #no.of days
    i['days_in_week']=5
